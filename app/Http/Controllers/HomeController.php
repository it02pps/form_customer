...
class HomeController extends Controller
{
    ...
    protected function validator($data)
    {
        ...
        $message = [
            ...
            'nama_finance.required' => 'Nama finance tidak harus diisi',
            'no_hp_finance.required' => 'No HP finance harus diisi',
            'email_finance.required' => 'Email finance harus diisi',
            'email_finance.email' => "Format email tidak valid",
        ...
        try {
            ...
            if ($request->bentuk_usaha == 'perseorangan') {
                ...
                if ($request->hasFile('foto_ktp')) {
                    ...
                    DB::table('identitas_perusahaan')->where('id', $identitas_perusahaan->id)->update([
                        'foto_ktp' => $filename,
            ...
            if ($request->hasFile('foto_penanggung')) {
                ...
                DB::table('data_identitas')->where('id', $identitas_penanggung_jawab->id)->update([
                    'foto' => $filename,
            ...
            $finance = DataFinance::firstOrNew([
                'identitas_perusahaan_id' => $dekripsi
            ]);
            $finance->identitas_perusahaan_id = $identitas_perusahaan->id;
            $finance->nama = $request->nama_finance;
            $finance->no_hp = $request->no_hp_finance;
            $finance->email = $request->email_finance;
            $finance->save();
