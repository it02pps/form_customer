                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jenis_cust" id="jenis_cust" class="form-control" readonly autocomplete="off" value="{{ strtoupper($perusahaan['status_cust']) }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="group @if($perusahaan['bidang_usaha'] != 'group') d-none @endif">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="group-column">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nitku" id="nitku" class="form-control" readonly autocomplete="off" readonly value="{{ $perusahaan['nitku'] ? $perusahaan['nitku'] : '-' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
