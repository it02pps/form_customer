                ...
                <div class="row g-3">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group position-relative" id="select">
                            ...
                            <span class="caret position-absolute top-50 end-0" style="right: 15px !important;">
                                <i class="fa-solid fa-caret-down text-secondary"></i>
                            </span>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="w-100 text-end">
                            <button
                                type="button"
                                class="btn btn-primary w-auto w-md-100"
                                id="addRow"
                            >
                        ...
                        <div class="dynamic-row">
                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column gap-3">
                                    <div class="row counter-1 numDiv">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="d-flex flex-column gap-3">
        ...
        $(document).ready(function() {
            ...
            $('#addRow').on('click', function() {
                ...
                $('.dynamic-row').append(`
                    ...
                    <div class="w-100">
                        <div class="row counter-${counter} numDiv">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="d-flex flex-column gap-3">
                                    <div class="form-group-modal">
                                        <label for="">Nomor NITKU (22 digit) <span class="text-danger">*</span></label>
            ...
            $(document).on('keyup','#nama_perusahaan, #nama_group_perusahaan, #alamat_lengkap, #alamat_group_lengkap, #bidang_usaha_lain, #nama_group, #nama_npwp, #badan_usaha_lain, #alamat_npwp, #kota_npwp, #nama_rekening, #nama_bank, #rekening_lain, #nama_penanggung_jawab, #jabatan, #kota_kabupaten, #nama_cabang, #alamat_nitku, #nama_finance', function() {
