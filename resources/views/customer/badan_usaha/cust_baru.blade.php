                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_finance" id="nama_finance" class="form-control" autocomplete="off" placeholder="Masukkan nama finance" required>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label for="">No HP Finance <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="no_hp_finance" id="no_hp_finance" maxlength="14" autocomplete="off" placeholder="Masukkan no hp finance" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Email Finance <span class="text-danger">*</span></label>
                                <input type="email" name="email_finance" id="email_finance" class="form-control" autocomplete="off" placeholder="Masukkan email finance" required>
                            </div>
                        </div>
                        <hr>
