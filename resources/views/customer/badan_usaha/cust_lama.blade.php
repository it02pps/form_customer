                                                ...
                                                @if ($data['sppkp'])
                                                    ...
                                                    @elseif(File::extension($data['sppkp']) != 'pdf')
                                                        <div id="preview_sppkp" class="form-group">
                                                            {{-- <img id="preview_foto_sppkp" src="{{ url('/form-customer/getFiles/FileSPPKPCompany/' . $perusahaan['sppkp']) }}" alt="Belum ada file" data-action="zoom"> --}}
                                                            <img id="preview_foto_sppkp" src="{{ asset('/uploads/identitas_perusahaan/' . $perusahaan['sppkp']) }}" alt="Belum ada file" data-action="zoom">
                                                        </div>
                                                    @else
                                                        <div id="preview_sppkp" class="form-group">
                                            ...
                                            @if ($data['foto_npwp'])
                                                ...
                                                @elseif(File::extension($data['foto_npwp']) != 'pdf')
                                                    <div id="preview_npwp" class="form-group">
                                                        {{-- <img id="preview_foto_npwp" src="{{ url('/form-customer/getFiles/FileIDCompanyOrPersonal/' . $perusahaan['foto_npwp']) }}" alt="Belum ada file" data-action="zoom"> --}}
                                                        <img id="preview_foto_npwp" src="{{ asset('/uploads/identitas_perusahaan/' . $perusahaan['foto_npwp']) }}" alt="Belum ada file" data-action="zoom">
                                                    </div>
                                                @else
                                                    <div id="preview_npwp" class="form-group">
                                                        <p class="text-center">Belum ada file</p>
