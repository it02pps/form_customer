                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_finance" id="nama_finance" placeholder="Masukkan nama finance" class="form-control" autocomplete="off" required value="{{ $data ? ($data['data_finance'] ? ($data['data_finance']['nama'] ?: '') : '') : '' }}">
                                    </div>
                                </div>
                                <div class="colxl6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label for="">No HP Finance <span class="text-danger">*</span></label>
                                        <input type="text" name="no_hp_finance" id="no_hp_finance" class="form-control" autocomplete="off" placeholder="Masukkan no HP finance" maxlength="14" required value="{{ $data ? ($data['data_finance'] ? ($data['data_finance']['no_hp'] ?: '') : '') : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
