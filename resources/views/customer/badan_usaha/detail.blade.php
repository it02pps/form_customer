                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_finance" id="nama_finance" class="form-control" placeholder="Masukkan nama finance" autocomplete="off" readonly value="{{ $perusahaan['data_finance']['nama'] ?: '-' }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="">No HP Finance</label>
                                    <input type="text" name="no_hp_finance" id="no_hp_finance" class="form-control" placeholder="Masukkan no HP finance" maxlength="14" autocomplete="off" readonly value="{{ $perusahaan['data_finance']['no_hp'] ?: '-' }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Email Finance</label>
                            <input type="email" name="email_finance" id="email_finance" class="form-control" placeholder="Masukkan email finance" autocomplete="off" readonly value="{{ $perusahaan['data_finance']['email'] ?: '-' }}">
                        </div>
                    </div>
                    <hr>
                    <div class="section3">
