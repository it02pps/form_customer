    ...
    <div class="row justify-content-center">
        ...
        <form id="form_customer" enctype="multipart/form-data">
            ...
            <div class="content-footer d-flex justify-content-center mt-2">
                ...
                &nbsp;
                <button type="button" class="btn btn-primary waves-effect waves-light rounded btn-md" id="konfirmasi" data-id="{{ $enkripsi }}" data-usaha="{{ str_replace('_', '-', $perusahaan['bentuk_usaha']) }}" title="Upload Data Customer">Upload Data Customer</button>
            </div>
        </form>
    </div>
</div>
