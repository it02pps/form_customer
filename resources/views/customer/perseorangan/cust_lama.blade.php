                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_group_lengkap" id="alamat_group_lengkap" class="form-control" placeholder="Masukkan alamat group usaha" autocomplete="off" required>{{ $data ? $data['alamat_lengkap'] : '' }}</textarea>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group" id="select">
                                        ...
                                        <div class="group d-none">
                                            <input type="text" class="form-control" name="nama_group" id="nama_group" placeholder="Masukkan nama group" autocomplete="off" value="{{ $data ? $data['nama_group'] : '' }}" readonly>
                                        </div>
                                        <span class="caret"><i class="fa-solid fa-caret-down text-secondary"></i></span>
                                    </div>
                                </div>
                                                    ...
                                                    @if ($data['foto_ktp'])
                                                        ...
                                                        @elseif(File::extension($data['foto_ktp']) != 'pdf')
                                                            <div class="form-group" id="preview_ktp">
                                                                ...
                                                                <img id="preview_foto_ktp" src="{{ asset('/uploads/identitas_perusahaan/' . $perusahaan['foto_ktp']) }}" alt="Belum ada file" data-action="zoom">
                                                            </div>
                                                        @else
                                                            <div class="form-group" id="preview_ktp">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomor_rekening" id="nomor_rekening" class="form-control" autocomplete="off" oninput="this.value = this.value.replace(/\D+/g, '')" maxlength="15" placeholder="Masukkan nomor rekening" required value="{{ $data ? $data['informasi_bank']['nomor_rekening'] : '' }}">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                            ...
                                            @if ($data['data_identitas']['foto'])
                                                ...
                                                @elseif(File::extension($data['data_identitas']['foto']) != 'pdf')
                                                    <div id="preview_penanggung" class="form-group">
                                                        {{-- <img id="preview_foto_penanggung" src="{{ url('/form-customer/getFiles/FileIDPersonCharge/' . $perusahaan['data_identitas']['foto']) }}" alt="Belum ada file" data-action="zoom"> --}}
                                                        <img id="preview_foto_penanggung" src="{{ asset('/uploads/penanggung_jawab/' . $perusahaan['data_identitas']['foto']) }}" alt="Belum ada file" data-action="zoom">
                                                    </div>
                                                @else
                                                    <div id="preview_penanggung" class="form-group">
                                                        <p class="text-center">Belum ada file</p>
