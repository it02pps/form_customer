                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_group_lengkap" id="alamat_group_lengkap" class="form-control" placeholder="Masukkan alamat group usaha" autocomplete="off" required>{{ $data ? $data['alamat_group_lengkap'] : '' }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alamat_email_perusahaan" id="alamat_email_perusahaan" class="form-control" autocomplete="off" placeholder="Masukkan alamat email usaha" value="{{ $data ? $data['alamat_email'] : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nomor_ktp" name="nomor_ktp" oninput="this.value = this.value.replace(/\D+/g, '')" maxlength="16" placeholder="Masukkan NIK" autocomplete="off" class="form-control" value="{{ $data ? ($data['nomor_ktp'] ? $data['nomor_ktp'] : $data['nomor_npwp']) : ''}}">
                                    </div>
                                </div>
                            </div>
                            <div id="ktp-section">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_finance" id="nama_finance" class="form-control" placeholder="Masukkan nama finance" autocomplete="off" required value="{{ $data ? ($data['data_finance']['nama'] ?: '') : '' }}">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label for="">No HP Finance <span class="text-danger">*</span></label>
                                        <input type="text" name="no_hp_finance" id="no_hp_finance" class="form-control" placeholder="Masukkan no HP finance" maxlength="14" autocomplete="off" required value="{{ $data ? ($data['data_finance']['no_hp'] ?: '') : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Email Finance <span class="text-danger">*</span></label>
                                <input type="email" name="email_finance" id="email_finance" class="form-control" placeholder="Masukkan email finance" autocomplete="off" required value="{{ $data ? ($data['data_finance']['email'] ?: '') : '' }}">
                            </div>
                        </div>
                        <hr>
                        <div class="section3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomor_hp_penanggung_jawab" id="nomor_hp_penanggung_jawab" oninput="this.value = this.value.replace(/[^0-9+]/g, '')" maxlength="14" autocomplete="off" class="form-control" required placeholder="Contoh: 012345678910" value="{{ $data ? $data['data_identitas'] ? $data['data_identitas']['no_hp'] : '' : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
