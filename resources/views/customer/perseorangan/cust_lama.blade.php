                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    required
                                    value="{{ $data ? $data['informasi_bank'] ? $data['informasi_bank']['nomor_rekening'] : '' : '' }}"
                                >
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    required
                                    value="{{ $data ? $data['informasi_bank'] ? $data['informasi_bank']['nama_rekening'] : '' : '' }}"
                                >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    required
                                    value="{{ $data ? $data['informasi_bank'] ? $data['informasi_bank']['nama_bank'] : '' : '' }}"
                                >
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="rekening_lain d-none">
                                        <input
                                            ...
                                            autocomplete="off"
                                            value="{{ $data ? $data['informasi_bank'] ? $data['informasi_bank']['rekening_lain'] : '' : '' }}"
                                        >
                                    </div>
                                    <span
                                        class="caret position-absolute"
