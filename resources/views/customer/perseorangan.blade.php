                        ...
                        <div class="row mb-2">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_perusahaan" id="nama_perusahaan" class="form-control" placeholder="Masukkan nama usaha" autocomplete="off" required value="{{ $data_perusahaan ? $data_perusahaan['nama_perusahaan'] : '' }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                        ...
                        <div class="row mb-2">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat_lengkap" id="alamat_lengkap" cols="30" rows="5" class="form-control" required autocomplete="off" placeholder="Masukkan alamat lengkap usaha">{{ $data_perusahaan ? $data_perusahaan['alamat_lengkap'] : '' }}</textarea>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="email" name="email_perusahaan" id="email_perusahaan" class="form-control" autocomplete="off" placeholder="Contoh: usaha@gmail.com" value="{{ $data_perusahaan ? $data_perusahaan['alamat_email'] : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    {{-- <input type="text" name="no_hp" id="no_hp" maxlength="13" oninput="this.value = this.value.replace(/\D+/g, '')" class="form-control" placeholder="Contoh: 0812345678910" required autocomplete="off" value="{{ $data_perusahaan ? $data_perusahaan['nomor_handphone'] : '' }}"> --}}
                                    <input type="text" name="no_hp" id="no_hp" maxlength="14" oninput="this.value = this.value.replace(/[^0-9+]/g, '')" class="form-control" placeholder="Contoh: 0812345678910" required autocomplete="off" value="{{ $data_perusahaan ? $data_perusahaan['nomor_handphone'] : '' }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukkan bidang usaha lain" id="bidang_usaha_lain" name="bidang_usaha_lain" autocomplete="off" value="{{ $data_perusahaan ? $data_perusahaan['bidang_usaha'] ? $data_perusahaan['bidang_usaha_lain'] : '' : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" autocomplete="off" placeholder="Masukkan nama group" id="nama_group" name="nama_group" value="{{ $data_perusahaan ? $data_perusahaan['status_kepemilikan'] == 'lainnya' ? $data_perusahaan['nama_group'] : '' : '' }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ktp-section">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control" autocomplete="off" placeholder="Masukkan nama lengkap sesuai identitas" value="{{ $data_perusahaan ? ($data_perusahaan['identitas'] == 'ktp' ? $data_perusahaan['nama_lengkap'] : '') : '' }}">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ktp-section">
                            <label for="">NIK <span class="text-danger">*</span></label>
                            <input type="text" name="nomor_ktp" id="nomor_ktp" oninput="this.value = this.value.replace(/\D+/g, '')" class="form-control" maxlength="16" autocomplete="off" placeholder="Masukkan NIK" value="{{ $data_perusahaan ? ($data_perusahaan['identitas'] == 'ktp' ? $data_perusahaan['nomor_ktp'] : '') : '' }}">
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="nomor_npwp" id="nomor_npwp" oninput="this.value = this.value.replace(/\D+/g, '')" maxlength="20" class="form-control" autocomplete="off" placeholder="Masukkan nomor NPWP" value="{{ $data_perusahaan ? ($data_perusahaan['identitas'] == 'npwp' ? $data_perusahaan['nomor_npwp'] : '' ) : '' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" name="email_faktur" id="email_faktur" class="form-control" autocomplete="off" placeholder="Contoh: faktur@gmail.com" value="{{ $data_perusahaan ? ($data_perusahaan['identitas'] == 'npwp' ? $data_perusahaan['email_khusus_faktur_pajak'] : '') : '' }}">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                        ...
                        <div class="row mb-3">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_rekening" id="nomor_rekening" oninput="this.value = this.value.replace(/\D+/g, '')" class="form-control" maxlength="15" autocomplete="off" required placeholder="Masukkan nomor rekening" value="{{ $data_perusahaan ? $data_perusahaan['informasi_bank']['nomor_rekening'] : '' }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="rekening_lain" name="rekening_lain" placeholder="Masukkan pemilik rekening" autocomplete="off" value="{{ $data_perusahaan ? $data_perusahaan['informasi_bank'] ? $data_perusahaan['informasi_bank']['rekening_lain'] : '' : '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_hp_penanggung_jawab" id="nomor_hp_penanggung_jawab" oninput="this.value = this.value.replace(/[^0-9+]/g, '')" class="form-control" placeholder="Contoh: 0812345678910" maxlength="14" autocomplete="off" value="{{ $data_perusahaan ? $data_perusahaan['data_identitas'] ? $data_perusahaan['data_identitas']['no_hp'] : '' : '' }}">
                                </div>
