                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nomor_npwp" id="nomor_npwp" class="form-control" autocomplete="off" placeholder="Masukkan Nomor NPWP" value="{{ $data ? $data['nomor_npwp'] : '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="group-column">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nitku" id="nitku" class="form-control" autocomplete="off" placeholder="Masukkan NITKU untuk penerbitan Faktur Pajak" value="{{ $data ? $data['nitku'] : '' }}">
                                            </div>
