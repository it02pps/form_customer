...
@section('content')
    ...
    <div class="px-4 py-3 px-md-5">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            @if($fotoNPWP)
                                <div class="form-group {{ $extNPWP === 'pdf' ? 'd-flex justify-content-between align-items-center py-2 px-3 m-0' : 'p-0' }}" id="preview_npwp" style="{{ $extNPWP === 'pdf' ? 'auto' : '271px' }}">
                                    @if($extNPWP === 'pdf')
                        ...
                        <div class="form-group mt-3" id="cabang">
                ...
                <div class="row g-3">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nomor_rekening" id="nomor_rekening" readonly class="form-control" autocomplete="off" value="{{ $data['informasi_bank'] ? ($data['informasi_bank']['nomor_rekening'] ?: '-') : '-' }}">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="group-column">
                            <div class="form-group">
                                ...
                                <input type="text" name="status" id="pemilik_rekening" class="form-control" autocomplete="off" readonly value="{{ $data['informasi_bank'] ? (ucwords(str_replace('_', ' ', $data['informasi_bank']['status'])) ?: '-') : '-' }}">
                                <div class="rekening_lain p-0 @if($data['informasi_bank'] && $data['informasi_bank']['status'] != 'lainnya') d-none @endif">
                                    <input type="text" class="form-control" name="rekening_lain" id="rekening_lain" readonly autocomplete="off" value="{{ $data['informasi_bank'] ? ($data['informasi_bank']['rekening_lain'] ?: '-') : '-' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_finance" id="nama_finance" class="form-control" placeholder="Masukkan nama finance" autocomplete="off" readonly value="{{ $data['data_finance'] ? ($data['data_finance']['nama'] ?: '-') : '-' }}">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            <label for="">No HP Finance</label>
                            <input type="text" name="no_hp_finance" id="no_hp_finance" class="form-control" placeholder="Masukkan no HP finance" maxlength="14" autocomplete="off" readonly value="{{ $data['data_finance'] ? ($data['data_finance']['no_hp'] ?: '-') : '-' }}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="">Email Finance</label>
                    <input type="text" name="email_finance" id="email_finance" placeholder="Masukkan email finance" class="form-control" autocomplete="off" readonly value="{{ $data['data_finance'] ? ($data['data_finance']['email'] ?: '-') : '-' }}">
                </div>
            </div>
            <hr>
                ...
                <div class="row g-3">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_penanggung_jawab" id="nama_penanggung_jawab" readonly autocomplete="off" class="form-control" value="{{ $data['data_identitas'] ? ($data['data_identitas']['nama'] ?: '-') : '-' }}">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nomor_hp_penanggung_jawab" id="no_hp_penanggung_jawab" readonly autocomplete="off" class="form-control" value="{{ $data['data_identitas'] ? ($data['data_identitas']['no_hp'] ?: '-') : '-' }}">
                        </div>
                    </div>
                </div>
                <div class="row g-3">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group p-0">
                            ...
                            @if($fotoPenanggung)
                                <div class="form-group {{ $extPenanggung === 'pdf' ? 'd-flex justify-content-between align-items-center py-2 px-3 m-0' : 'p-0' }}" id="preview_npwp" style="height: {{ $extPenanggung === 'pdf' ? 'auto' : '271px' }};">
        ...
        <div class="d-flex flex-column-reverse flex-md-row justify-content-md-end w-100 gap-2 mt-4" id="footer">
            <button type="button" class="btnKembali btn btn-outline-danger" title="Kembali">Kembali</button>
            <button type="button" class="btnEditData btn btn-warning" title="Edit Data Customer" data-url="{{ $url }}">Edit Data Customer</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formUploadPdf" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column-reverse flex-md-row gap-2 w-100 mt-4">
                            <button type="button" class="btnBatal btn btn-outline-danger w-100" data-bs-dismiss="modal" title="Batal">Batal</button>
                            <button type="submit" class="btnUpload btn btn-primary w-100">Upload File</button>
                        </div>
                    </form>
                </div>
            </div>
