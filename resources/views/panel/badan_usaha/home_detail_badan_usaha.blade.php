                ...
                <div class="row g-3">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_hp_finance" id="no_hp_finance" class="form-control" placeholder="Masukkan no HP finance" maxlength="20" autocomplete="off" readonly value="{{ $data['data_finance'] ? ($data['data_finance']['no_hp'] ?: '-') : '-' }}">
                        </div>
                    </div>
                </div>
                <div class="form-group">
