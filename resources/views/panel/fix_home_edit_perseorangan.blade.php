                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="alamat_npwp" id="alamat_npwp" cols="70" rows="10" autocomplete="off" class="form-control" placeholder="Masukkan alamat sesuai NPWP">{{ $data['alamat_npwp'] ? $data['alamat_npwp'] : '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
