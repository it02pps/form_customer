                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group p-0">
                                    ...
                                    <input type="text" name="nama_sales" id="nama_sales" class="form-control" autocomplete="off" readonly value="<?php echo e($perusahaan['nama_sales'] ? $perusahaan['nama_sales'] : '-'); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="group-column">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_group_usaha" id="alamat_group_usaha" class="form-control" rows="6" autocomplete="off" readonly><?php echo e($perusahaan['alamat_group_lengkap']); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php else: ?>
                                                    <div id="preview_ktp" class="form-group">
                                                        <img id="preview_foto_ktp" src="<?php echo e($perusahaan['foto_ktp'] ? asset('../../../uploads/identitas_perusahaan/' . $perusahaan['foto_ktp']) : '-'); ?>" alt="Belum ada file" data-action="zoom">
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="group-column">
                                        <div class="form-group">
                                            ...
                                            <textarea name="alamat_ktp" id="alamat_ktp" class="form-control" rows="6" autocomplete="off" readonly><?php echo e($perusahaan['alamat_ktp']); ?></textarea>
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\form_customer\resources\views/customer/perseorangan/detail.blade.php ENDPATH**/ ?>