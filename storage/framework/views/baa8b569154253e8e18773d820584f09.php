                            ...
                            <div class="row mb-2">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_perusahaan" id="nama_perusahaan" class="form-control" placeholder="Masukkan nama merk usaha" autocomplete="off" required value="<?php echo e($data_perusahaan ? $data_perusahaan['nama_perusahaan'] : ''); ?>">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ktp-section">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control" autocomplete="off" placeholder="Masukkan nama lengkap" value="<?php echo e($data_perusahaan ? ($data_perusahaan['identitas'] == 'ktp' ? $data_perusahaan['nama_lengkap'] : '') : ''); ?>">
                                </div>
                            </div>
                            <div class="ktp-section">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <input type="text" name="nomor_ktp" id="nomor_ktp" class="form-control" autocomplete="off" placeholder="Masukkan nomor KTP" value="<?php echo e($data_perusahaan ? ($data_perusahaan['identitas'] == 'ktp' ? $data_perusahaan['nomor_ktp'] : '') : ''); ?>">
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="form-group mb-2" id="penanggung_ktp">
                                        ...
                                        <div id="preview_ktp_penanggung" class="<?php if($data_perusahaan): ?> <?php if($data_perusahaan['data_identitas']['identitas'] != 'ktp'): ?> d-none <?php endif; ?> <?php else: ?> d-none <?php endif; ?>">
                                    ...
                                    <div class="form-group <?php if($data_perusahaan): ?> <?php if($data_perusahaan['data_identitas']['identitas'] != 'npwp'): ?> d-none <?php endif; ?> <?php else: ?> d-none <?php endif; ?>" id="penanggung_npwp">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomor_hp_penanggung_jawab" id="nomor_hp_penanggung_jawab" class="form-control" placeholder="Masukkan no hp penanggung jawab" autocomplete="off" value="<?php echo e($data_perusahaan ? $data_perusahaan['data_identitas'] ? $data_perusahaan['data_identitas']['no_hp'] : '' : ''); ?>">
                                    </div>
