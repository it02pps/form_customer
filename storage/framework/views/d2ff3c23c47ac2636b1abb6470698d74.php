                    ...
                    <div class="row mb-3">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <?php if($data['tahun_berdiri']): ?>
                                    <p><?php echo e(\Carbon\Carbon::parse($data['tahun_berdiri'])->locale('id')->settings(['formatFunction' => 'translatedFormat'])->format('d F Y')); ?></p>
                                <?php else: ?>
                                    <p>-</p>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <?php if($data['lama_usaha']): ?>
                                    <p><?php echo e($data['lama_usaha']); ?> tahun</p>
                                <?php else: ?>
                                    <p>-</p>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <p><?php echo e($data['bidang_usaha']); ?></p>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="row mb-3">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="form-group mb-2">
                                ...
                                <?php if($data['data_identitas']): ?>
                                    <p><?php echo e(strtoupper($data['data_identitas']['identitas'])); ?></p>
                                <?php else: ?>
                                    <p>-</p>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="form-group mb-2" id="penanggung_ktp">
                                ...
                                <?php if($data['data_identitas']): ?>
                                    <div id="preview_ktp_penanggung" class="<?php if($data['data_identitas']['identitas'] != 'ktp'): ?> d-none <?php endif; ?>">
                                        ...
                                        <?php else: ?>
                                            <img id="preview_foto_ktp_penanggung" src="<?php echo e(asset('uploads/penanggung_jawab/'.$data['data_identitas']['foto'])); ?>" alt="Preview" data-action="zoom">
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
                                    <p>-</p>
                            ...
                            <div class="form-group <?php if($data['data_identitas']): ?> <?php if($data['data_identitas']['identitas'] != 'npwp'): ?> d-none <?php endif; ?> <?php else: ?> d-none <?php endif; ?>" id="penanggung_npwp">
                                ...
                                <?php if($data['data_identitas']): ?>
                                    <div id="preview_npwp_penanggung" class="d-none">
                                        ...
                                        <?php else: ?>
                                            <img id="preview_foto_npwp_penanggung" src="<?php echo e(asset('uploads/penanggung_jawab/'.$data['data_identitas']['foto'])); ?>" alt="Preview" data-action="zoom">
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
                                    <p>-</p>
                        ...
                        <?php if($data['data_identitas']): ?>
                            <?php if($data['bentuk_usaha'] == 'perseorangan'): ?>
                                <?php if($data['data_identitas']['ttd']): ?>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="">
                                            ...
                                            <div id="signature">
                                                <img src="<?php echo e(asset('uploads/ttd/'.$perusahaan['data_identitas']['ttd'])); ?>" alt="" style="width: 100%;" data-action="zoom">
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Other\laragon\www\FormCustomer\resources\views/home_detail.blade.php ENDPATH**/ ?>