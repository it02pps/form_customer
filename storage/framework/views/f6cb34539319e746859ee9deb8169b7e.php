                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div id="preview_ktp" class="<?php if($perusahaan['identitas'] != 'ktp'): ?> d-none <?php endif; ?>">
                                            ...
                                            <?php else: ?>
                                                <img id="preview_foto_ktp" src="<?php echo e(route('showimage.view', ['category' => 'KTP', 'filename' => $perusahaan['foto_ktp']])); ?>" data-action="zoom">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="form-group mb-4 <?php if($perusahaan['status_pkp'] !=  'pkp'): ?> d-none <?php endif; ?>" id="sppkp-section">
                                            ...
                                            <div id="preview_sppkp">
                                                ...
                                                <?php else: ?>
                                                    <img id="preview_foto_sppkp" src="<?php echo e(route('showimage.view', ['category' => 'SPPKP', 'filename' => $perusahaan['sppkp']])); ?>" data-action="zoom">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div id="preview_npwp" class="<?php if($perusahaan['identitas'] != 'npwp'): ?> d-none <?php endif; ?>">
                                            ...
                                            <?php else: ?>
                                                <img id="preview_foto_npwp" src="<?php echo e(route('showimage.view', ['category' => 'NPWP', 'filename' => $perusahaan['foto_npwp']])); ?>" data-action="zoom">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <?php if($perusahaan['data_identitas']): ?>
                                        <?php if($perusahaan['data_identitas']['foto']): ?>
                                            <div id="preview_ktp_penanggung" class="<?php if($perusahaan['data_identitas']): ?> <?php if($perusahaan['data_identitas']['identitas'] != 'ktp'): ?> d-none <?php endif; ?> <?php endif; ?>">
                                                ...
                                                <?php else: ?>
                                                    <img id="preview_foto_ktp_penanggung" src="<?php echo e(route('showimage.view', 
                                ...
                                <div class="form-group <?php if($perusahaan['data_identitas']): ?> <?php if($perusahaan['data_identitas']['identitas'] != 'npwp'): ?> d-none <?php endif; ?> <?php else: ?> d-none <?php endif; ?>" id="penanggung_npwp">
                                    ...
                                    <?php if($perusahaan['data_identitas']): ?>
                                        <div id="preview_npwp_penanggung" class="d-none">
                                            ...
                                            <?php else: ?>
                                                <img id="preview_foto_npwp_penanggung" src="<?php echo e(route('showimage.view', ['category' => 'NPWP_responsible', 'filename' => $perusahaan['data_identitas']['foto']])); ?>" data-action="zoom">
                                            <?php endif; ?>
                                        </div>
                                    <?php else: ?>
                                        <p>-</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WEB APP\Form_Customer\form_customer\resources\views/customer/badan_usaha_detail.blade.php ENDPATH**/ ?>