                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="group-column">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_group_lengkap" id="alamat_group_lengkap" class="form-control" rows="6" readonly autocomplete="off"><?php echo e($data['alamat_group_lengkap']); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="group-column">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_wa" id="no_wa" class="form-control" autocomplete="off" readonly value="<?php echo e($data['nomor_whatsapp'] ? $data['nomor_whatsapp'] : '-'); ?>">
                                    </div>
                                    ...
                                    <div class="pkp p-0 <?php if($data['status_pkp'] != 'pkp'): ?> d-none <?php endif; ?>">
                                        <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\form_customer\resources\views/panel/badan_usaha/home_detail_badan_usaha.blade.php ENDPATH**/ ?>