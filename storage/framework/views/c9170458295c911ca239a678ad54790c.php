            ...
            <div class="content">
                ...
                <div class="content-body">
                    <div class="section1">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="bidang_lain <?php if($data['bidang_usaha'] != 'lainnya'): ?> d-none <?php endif; ?>">
                                        <input type="text" class="form-control" name="bidang_usaha_lain" id="bidang_usaha_lain" autocomplete="off" value="<?php echo e($data['bidang_usaha_lain'] ? $data['bidang_usaha_lain'] : '-'); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="group <?php if($data['status_kepemilikan'] != 'group'): ?> d-none <?php endif; ?>">
                                        <input type="text" class="form-control" name="nama_group" id="nama_group" autocomplete="off" value="<?php echo e($data['nama_group'] ? $data['nama_group'] : '-'); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="identitas_perusahaan" id="identitas_perusahaan" autocomplete="off" class="form-control" readonly value="<?php echo e(strtoupper($data['identitas'])); ?>">
                                </div>
                            </div>
                            <div id="ktp-section" class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 <?php if($data['identitas'] != 'ktp'): ?> d-none <?php endif; ?>">
                                <div class="form-group">
                                    <label for="">NIK</label>
                        ...
                        <div id="ktp-section" class="<?php if($data['identitas'] != 'ktp'): ?> d-none <?php endif; ?>">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                        ...
                        <div id="npwp-section" class="<?php if($data['identitas'] != 'npwp'): ?> d-none <?php endif; ?>">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label for="">Nama NPWP</label>
                                        <input type="text" name="nama_npwp" id="nama_npwp" class="form-control" autocomplete="off" readonly value="<?php echo e($data['nama_npwp'] ? $data['nama_npwp'] : '-'); ?>">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        <label for="">Nomor NPWP</label>
                                        <input type="text" name="nomor_npwp" id="nomor_npwp" class="form-control" autocomplete="off" readonly value="<?php echo e($data['nomor_npwp'] ? $data['nomor_npwp'] : '-'); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="group-column">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nitku" id="nitku" class="form-control" autocomplete="off" readonly value="<?php echo e($data['nitku'] ? $data['nitku'] : '-'); ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="">Kota Sesuai NPWP</label>
                                            <input type="text" name="kota_npwp" id="kota_npwp" class="form-control" autocomplete="off" readonly value="<?php echo e($data['kota_npwp'] ? $data['kota_npwp'] : '-'); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_npwp" id="alamat_npwp" cols="70" rows="10" autocomplete="off" class="form-control" readonly><?php echo e($data['alamat_npwp'] ? $data['alamat_npwp'] : '-'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="group-column">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <input type="text" name="status_pkp" id="status_pkp" class="form-control" autocomplete="off" readonly value="<?php echo e($data['status_pkp'] ? strtoupper(str_replace('_', ' ', $data['status_pkp'])) : '-'); ?>">
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Other\laragon\www\FormCustomer\resources\views/panel/fix_home_detail_perseorangan.blade.php ENDPATH**/ ?>