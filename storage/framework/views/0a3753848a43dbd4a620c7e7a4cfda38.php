                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <div id="preview_penanggung" class="form-group">
                                            <img id="preview_foto_penanggung" src="<?php echo e($data['data_identitas']['foto'] ? asset('../../../uploads/penanggung_jawab/' . $data['data_identitas']['foto']) : '-'); ?>" alt="Belum ada file" data-action="zoom">
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="form-group" id="ttd_credit">
                                    ...
                                    <div id="signature">
                                        <img src="<?php echo e($data['data_identitas']['ttd'] ? asset('../../../uploads/ttd/' . $data['data_identitas']['ttd']) : '-'); ?>" alt="Belum ada tanda tangan" data-action="zoom">
                                    </div>
                                </div>
                            </div>
                        </div>
