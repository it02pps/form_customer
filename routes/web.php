...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::post('/form-customer/internal/panel/edit-store', [HomeController::class, 'edit_store'])->name('home.edit_store');
    Route::get('/form-customer/internal/panel/edit/{id}', [HomeController::class, 'edit'])->name('home.edit');
    Route::get('/form-customer/internal/panel/get-pdf/{id}', [HomeController::class, 'getPdf'])->name('home.getPdf');
    Route::get('/form-customer/internal/panel/select/{id}', [HomeController::class, 'select'])->name('home.select');
    Route::get('/form-customer/internal/panel/delete-cust', [HomeController::class, 'hapusCustomer'])->name('home.delete');

    // Update profil & Password
    Route::post('/form-customer/internal/panel/update-profil', [HomeController::class, 'update_profil'])->name('home.update_profil');
    Route::post('/form-customer/internal/panel/forgot-password', [HomeController::class, 'forgot_password'])->name('home.forgot_password');
});
